...
* Friday 16 December 2022, noon - 1pm	
	**Zane Schwartz**, [Investigative Journalism Foundation](www.theijf.org)    
...
| Fri 25 Feb 2022, noon - 1pm | [Toronto Workshop on Reproducibility](https://rohanalexander.com/reproducibility.html) | |
...
* Fri 28 Jan 2022, noon - 1pm, 
	**Ashok Chaurasia**, University of Waterloo, *'Multiple Imputation: Old and New Combining Rules for Statistical Inference'*    
	Dr. Ashok Chaurasia is an Assistant Professor (of Statistics) in the School of Public Health Sciences at University of Waterloo. 
His background/training is in Statistics, with research interests in topics of Missing Data, Data Imputation, Model Selection, and Longitudinal Data Analysis Methodology.
...
* Fri 18 Feb 2022, noon - 1pm, 
	**Vincent Arel-Bundock**, Université de Montréal, *'What `modelsummary` taught me about R package development'*    
...
* Friday, 1 October 2021, noon - 1pm  
    ...
    * Professor [David Andrews](https://utstat.toronto.edu/david/) on elections forecasting.
    * Professor [Daniel Rubenson](https://www.rubenson.org) on the Canadian Election Study.
...
* Friday, 15 October 2021, noon - 1pm  
	**Drew Stommes**, Department of Political Science, Yale University    
	[Drew Stommes](https://drew-stommes.github.io) is a doctoral candidate in the Department of Political Science at Yale University, where he researches democracy, political violence, and quantitative methods. He will talk about a recent [working paper](https://arxiv.org/abs/2109.14526), 'On the reliability of published findings using the regression discontinuity design in political science'.
...
```{r, out.width= "33%", echo = FALSE}
knitr::include_graphics(c("images/tdw_cn_tower.png", "images/TorontoDataWorkshopMapleLeafs.png")) 
```
...
| Fri 20 August 2021, noon-1pm | Students from [Vianey Leos Barajas'](https://vleosbarajas.com) research group, *University of Toronto* | Sharks, lizards, and basketball! | https://youtu.be/p697exbcMZE |


* Friday, 21 May 2021, Noon - 1pm  
	**David Shor**, OpenLabs    
	Bio: [David](https://davidshor.io) is an American data scientist who tries to elect Democrats. He is known for analyzing political polls and currently serves as head of data science with OpenLabs, a progressive nonprofit, and also as a Senior Fellow with the Center for American Progress Action Fund.    
...
* Friday, 6 August 2021, 12:30pm - 1pm  
	**Ijeamaka Anyene**, Kaiser Permanente Division of Research  
	Bio: [Ijeamaka](https://ijeamaka-anyene.netlify.app) is a data analyst working in healthcare research. She specializes in using R and SAS for data analysis, epidemiological research, and data visualizations. She is also passionate about computational art, knowledge sharing / dissemination, and how to mix the two.    
...
| Thu 25 Feb, 9:00-5:30pm 	| Various			| [*Toronto Workshop on Reproducibility*](https://rohanalexander.com/reproducibility) | See [here](https://rohanalexander.com/reproducibility). |
| Fri 26 Feb, 9:00-5:30pm 	| Various		| [*Toronto Workshop on Reproducibility*](https://rohanalexander.com/reproducibility) | See [here](https://rohanalexander.com/reproducibility). |
...
| Mon 15 Mar, 4:00-5:00pm 	| Todd Feathers, *Freelance reporter* 			| Algorithmic fairness in universities. *(jointly hosted with [Maryclare Griffin](https://maryclare.github.io))* | https://youtu.be/Hw5viOofnC0 |
...
* Monday, 15 February, Noon-1:00pm  
	**Emily Riederer**, Capital One  
	...
	Topic: [Causal design patterns for data analysts](https://emilyriederer.netlify.app/post/causal-design-patterns/).
...
* Thursday, 25 February, 9:00-6:30pm  
	**Various speakers**  
	[*Toronto Workshop on Reproducibility*](https://rohanalexander.com/reproducibility)
* Friday, 26 February, 8:00-6:00pm  
	**Various speakers**  
	[*Toronto Workshop on Reproducibility*](https://rohanalexander.com/reproducibility)
...
* Monday, 15 March, 4:00-5:00pm  
	**Todd Feathers**, Freelance reporter  
	...
	Todd will talk about ['Major Universities are Using Race as a "High Impact Predictor" of Student Success'](https://themarkup.org/news/2021/03/02/major-universities-are-using-race-as-a-high-impact-predictor-of-student-success) published in *The Markup* on 2 March 2021.
