...
The Toronto Data Workshop (TDW) brings together academia and industry to share data science best practice. We are broadly interested, but especially in the code- and data-centric aspects of a data science project typically otherwise glossed over. We meet weekly for an hour, mostly via Zoom, with most talks recorded and shared. 
...
- Friday 17 May 2024, noon (EDT) (not recorded)
...
- Friday 24 May 2024, noon (EDT)
	- **Belinda Li**, MIT
	- "TBD"
	- [Belinda Li](https://belindal.github.io/) is a third-year PhD student at MIT CSAIL, affiliated with the language & intelligence (LINGO) lab @ MIT. Her advisor is Jacob Andreas. She has broad interests within natural language processing, but some high-level themes of recent work include: 1) Probing for representations of meaning in language models 2) Using language models for various natural-language tasks and grounded tasks. (What characterizes the space of tasks humans may be interested in? How do we transfer linguistic knowledge to grounded tasks? How do we best specify human intent to a language model?) 3) Improving the coherence and faithfulness of machine generations. She is funded by an NDSEG Fellowship and Clare Boothe Luce Graduate Fellowship. Previously, she spent a year at Facebook AI Applied Research, and before that, she obtained a B.S. in Computer Science at the University of Washington, where she worked with Luke Zettlemoyer.
...
- Friday 14 June 2024, noon (EDT)
	...
	- [Jae Yeon Kim](https://jaeyk.github.io) is a senior data scientist at the Safety Net Innovations Lab at Code for America, and a research fellow at the SNF Agora Institute and P3 Lab at Johns Hopkins University, as well as the Center for Public Leadership and Civic Power Lab at Harvard Kennedy School. He holds a Ph.D. in political science from UC Berkeley.
