...
- You are asking about X, but you didn't teach that?
...
Before class starts you should go through [Telling stories with data](https://tellingstorieswithdata.com/01-introduction.html) and [R essentials](https://tellingstorieswithdata.com/20-r_essentials.html).
